...
###########################################################
# Modified for python 3.5, kivy 1.10.0 and Organiser App by RikedyP
# github.com/rikedyp
...
def get_month_names():
    ...
    # ----- TimeEncoding BROKEN--------------
    # TODO find another localisation method
    # result = []
...
def today_date():
    ...
    """ Return today date yyyy.mm.dd like 1995.01.24 - easier for sorting dates"""
